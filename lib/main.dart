...
class _TorchAppState extends State<TorchApp> {
  ...
  bool c =
      false; //variable used to control conditional statements in many places.
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      themeMode: c
          ? ThemeMode.light
          : ThemeMode
              .dark, //conditional statement used to change them according to on/off status.
      home: Scaffold(
        body: Container(
          color: th,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment
                .center, //will arrange image and text in center vertically.
            mainAxisAlignment: MainAxisAlignment
                .center, //will arrange image and text in center horizontally
            children: [
              TextButton(
                  ...
                  onPressed: () {
                    setState(() {
                      if (img == "bulb on") {
                        th =
                            Colors.black; //changing color accordingly to on/off
                        img = "bulb off";
                        txt = "Off";
                        c = false;
                        TorchLight
                            .disableTorch(); //used torch_Light package to control on or off and it is very simple just used on line to change flash light status but it is not recommended to use this way.
                      } else {
                        img = "bulb on";
                        txt = "On";
                        c = true;
